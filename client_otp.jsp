                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="client.jsp" class="active">CLIENT</a></li>
                            <li><a href="csp.jsp" style="color:black;">CSP</a></li> 
                            <li><a href="auditor.csp" style="color:black;">AUDITOR</a></li> 
                            <li class="main-button"><a href="register.jsp">REGISTER</a></li>
                        </ul>        
...
<div class="box">
<h1>CLIENT LOGIN</h1> 
<input type="password" name="otp" placeholder="ENTER OTP" required class="password" /> 
