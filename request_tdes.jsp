...
<%@page import="pack.download_tdes"%>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="banner">
                    ...
                    <table border="2" style="text-align: center;margin-left: 70px">
                            ...
                            %>
                                ...
                                <td> <a href="viewdata_tdes.jsp?id=<%=rs.getString("fileid")%>"><font style="color: green">view</a></font> </td>  
                                <td> <a href="download_tdes?id=<%=rs.getString("fileid")%>"><font style="color: green">Download</a></font> </td>   
                                <tr />
