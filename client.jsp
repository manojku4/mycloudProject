                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="client.jsp" class="active"><b>CLIENT</b></a></li>
...
<input type="submit" name="sent" value="Next" class="btn" > <!-- End Btn -->
<a href="register.html"><div id="btn2">Sign Up</div></a> <!-- End Btn2 -->
