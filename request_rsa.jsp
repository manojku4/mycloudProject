            ...
            <div class="banner">
                    ...
                    <table border="2" style="text-align: center;margin-left: 70px">
                            ...
                            %>
                                ...
                                <td> <a href="viewdata_rsa.jsp?id=<%=rs.getString("fileid")%>"><font style="color: green">view</a></font> </td>  
                                <td> <a href="Download_rsa?id=<%=rs.getString("fileid")%>"><font style="color: green">Download</a></font> </td>   
                                <tr />
